...
export declare const ACTIVITI_PROCESSLIST_DIRECTIVES: [any];
export declare const ACTIVITI_PROCESSLIST_PROVIDERS: [any];
export declare class ActivitiProcessListModule {
